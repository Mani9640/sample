namespace SportsStoreMVCWenApp.DataContexts.SportsStoreMigrations
{
    using System;
  ...
  using SportsStoreDomainLibrary.Entity;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SportsStoreDomainLibrary.SportsStoreDbContext>
    {
        ...
        protected override void Seed(SportsStoreDomainLibrary.SportsStoreDbContext context)
        {
